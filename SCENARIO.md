...
```bash
java -jar target/quarkus-app/quarkus-run.jar builder -o out/flows -c configurations/konflux/build-quarkus-app-1-cfg.yaml
```
using as configuration: 
```yaml
# configurations/konflux/build-quarkus-app-1-cfg.yaml
