...
```bash
java -jar target/quarkus-app/quarkus-run.jar builder -o out/flows -c configurations/konflux/build-quarkus-app-bash-jam-cfg.yaml
```
using as configuration: 
```yaml
# configurations/konflux/build-quarkus-app-bash-jam-cfg.yaml
...
Command to be executed: 
```bash
java -jar target/quarkus-app/quarkus-run.jar builder -o out/flows -c configurations/konflux/build-quarkus-app-bash-pack-cfg.yaml
```
using as configuration: 
```yaml
# configurations/konflux/build-quarkus-app-bash-pack-cfg.yaml
